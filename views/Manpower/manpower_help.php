...
<link href="<?php echo fullURLfront; ?>/assets/cs/manpower/manpower_help.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="column2">
            ...
            <div class="contact-section">
                ...
                <div class="contact-section-form">
                    <form action="<?php echo fullURLfront; ?>/Manpower/manpower_help" method="POST">
                        ...
                        <div class = "Button-section">
                            ...
                            <button type="submit" name="manpower_help" value="submitted" class="btn-submit">Request Help <i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                        </div>
                    </form>
                    <br><br>
