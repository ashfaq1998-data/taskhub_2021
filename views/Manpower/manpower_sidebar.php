...
<div class="sidebar">
    <ul>
        <li class="top"><a href="<?php echo fullURLfront; ?>/Manpower/manpower_dashboard"><i class="fa fa-search"></i> Search</a></li>
        <li><a href="<?php echo fullURLfront; ?>/Manpower/manpower_profile"><i class="fa fa-user"></i> Profile</a></li>
        <li><a href="<?php echo fullURLfront; ?>/Employee/employee_booking"><i class="fa fa-calendar"></i> Worker</a></li>
