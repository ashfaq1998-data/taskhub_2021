...
<link href="<?php echo fullURLfront; ?>/assets/cs/manpower/manpower_complaint.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="column2">
            <div class="subrow">
                ...
                <div class="subcolumn2">
                    <form action="<?php echo fullURLfront; ?>/Manpower/manpower_complaint" method="POST">
                        <fieldset>
                        ...
                        <div class ="ratebutton">
                            ...
                            <button type="submit" name="manpower_complaint" value="submitted" class="btn-submit"><i class="fa fa-frown-o"></i> Complain</button>
                            <br>
