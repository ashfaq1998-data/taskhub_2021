...
?>
    ...
    <head>
        ...
        <link href="<?php echo fullURLfront; ?>/assets/cs/admin/admin_editmanpower.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="page-wrapper">
                ...
                <div class="register-section">
                    <div class="register-section-form">
                        <h2>Add New Manpower Agency</h2><br>
                        <form action="<?php echo fullURLfront; ?>/Admin/admin_addmanpower" method="POST"> 
                            ...
                            <button type="submit" name="manpower_add" value="submitted" class="btn-submit">Add</button>
                        </form>
                        <br>
                        <p class="error"><?php echo $data['registerError']; ?></p>
                        
                    </div>
                    <img src="<?php echo fullURLfront; ?>/assets/images/manpoweredit.jpg" alt="image" height="50%" width="60%" style="margin-top: 50px;">
                </div>
