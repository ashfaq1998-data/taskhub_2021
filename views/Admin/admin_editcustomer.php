<?php
session_start();
$customerDetails = $data['profile_details'];
?>
    <!DOCTYPE html> 
    <html lang="en">
    <head>
            ...
            <div class="page-wrapper">
                ...
                <div class="register-section">
                    <div class="register-section-form">
                        ...
                        <form action="<?php echo fullURLfront; ?>/Admin/admin_editcustomer" method="POST" enctype="multipart/form-data"> 
                            <input type="hidden" id="iid" name="iid" value="<?php echo base64_encode($customerDetails->CustomerID); ?>">
                            ...
                            <label for="account" style="float: left;">Card Number</label>
                            <input type="text" id="accnum" name="accnum" placeholder="Account Number" value="<?php echo $customerDetails->Card_Number; ?>">
                            
                            <label for="bio" style="float: left;">Description</label>
                            <textarea rows="4" cols="50" placeholder="Enter yor bio"><?php echo $customerDetails->bio; ?></textarea>
                            <br>
