...
?>
    ...
    <head>
        ...
        <link href="<?php echo fullURLfront; ?>/assets/cs/admin/admin_editemployee.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="page-wrapper">
                ...
                <div class="register-section">
                    <div class="register-section-form">
                        ...
                        <form action="<?php echo fullURLfront; ?>/Admin/admin_addemployee" method="POST"> 
                            ...
                            <button type="submit" name="admin_addemployee" value="submitted" class="btn-submit">Add</button>
                        </form>
                        <br>
                        <p class="error"><?php echo $data['registerError']; ?></p>
                        
                    </div>
                    <img src="<?php echo fullURLfront; ?>/assets/images/man.jpg" alt="image" height="70%" width="60%" style="margin-top: 50px;">
                </div>
