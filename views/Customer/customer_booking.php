        ...
        <div class="column2">
            ...
            <div class="booking-details-section">
                ...
                <div class="booking-details-section-content">
                    <form>
                        <label for="topic">Type:</label><br>
                        <input type="text" id="topic" name="topic" value="" readonly><br>
                        <label for="fname">Full Name:</label><br>
                        <input type="text" id="fullname" name="fullname" value="" readonly><br>
...
<script src="<?php echo fullURLfront; ?>/assets/js/customer/customer_booking.js" type="text/javascript"></script>
</html>