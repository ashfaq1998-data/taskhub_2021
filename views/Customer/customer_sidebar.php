...
<div class="sidebar">
    <ul>
        ...
        <li><a href="<?php echo fullURLfront; ?>/Customer/customer_viewbook"><i class="fa fa-calendar"></i> View Booking</a></li>
        <li><a href="#"><i class="fa fa-calendar"></i> Make Booking</a></li>
