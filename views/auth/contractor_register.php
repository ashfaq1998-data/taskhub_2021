...
?>
    ...
    <head>
        ...
        <link href="<?php echo fullURLfront; ?>/assets/cs/auth/contractor_register.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="page-wrapper">
                ...
                <div class="register-section">
                    <div class="register-section-form">
                        <h2>Sign Up</h2><br>
                        <form action="<?php echo fullURLfront; ?>/auth/contractor_register" method="POST"> 
                            ...
                            <button type="submit" name="contractor_register" value="submitted" class="btn-submit">Register</button>
                        </form>
                        <br>
