...
<div class="sidebar">
    <ul>
        ...
        <li><a href="<?php echo fullURLfront; ?>/Contractor/contractor_complaint"><i class="fa fa-frown-o"></i> Complaints</a></li>
        <li><a href="<?php echo fullURLfront; ?>/Contractor/contractor_history"><i class="fa fa-history"></i> History</a></li>
        <li><a href="<?php echo fullURLfront; ?>/Contractor/contractor_help"><i class="fa fa-info-circle"></i> Help</a></li>
